...
cheatsheet = [
	{
		...
		'static_red': '03914442190444fb8b40f84b62c321af',
		'content': [
			[
				"""
...
if __name__ == '__main__':
   app.run(debug=True)         
	...
	},
	{
		...
		'description': '',
		'uuid': helper.get_uuid(),
		'static_red': 'fa42a9ed69ea4fb0a69f48a3699d2c5d',
		'content': [
			[
				"""
...
# uuid -> Accepts UUIDs (universally unique identifiers); think hexcode on steroids.
	...
	},
	{
		...
		'description': '',
		'uuid': helper.get_uuid(),
		'static_red': '39b6463db73c4ad7b8cfa10faf292813',
		'content': [
			[
				"""
...
@app.route('/test', methods=['POST','PUT']) # Allows 'PUT' and 'POST' and no other.
	...
	},
	{
		...
		'description': '',
		'uuid': helper.get_uuid(),
		'static_red': 'a3aa528279214e9d82620484aaf3b6ed',
		'content': [
			[
				"""
...
app.config.from_envvar('ENV_VAR_NAME') # Gets the value from an environment value. Useful for API keys and similar information.
	...
	},
	{
		...
		'description': '',
		'uuid': helper.get_uuid(),
		'static_red': '1076672d6c4c49c69827deaeff7b1ab6',
		'content': [
			[
				"""
...
@app.route('/')def index():
	...
	},
	{
		...
		'description': '',
		'uuid': helper.get_uuid(),
		'static_red': '6b908e789fa44324ae0b581196be4811',
		'content': [
			[
				"""
import jsonify
...
# Usefull if you f.e. want to create a REST API for connecting the backend to the frontend.    
	...
	},
	{
		...
		'description': '',
		'uuid': helper.get_uuid(),
		'static_red': '123b3dedb26e4984b1b673ff5d8b82ea',
		'content': [
			[
				"""
...
request.files['name'] # Retrieving a file    
	...
	},
	{
		...
		'description': '',
		'uuid': helper.get_uuid(),
		'static_red': '2c182d03ee0e4159b65eb216374f1f6d',
		'content': [
			[
				"""
...
def redirect_example():
	...
	},
	{
		...
		'description': '',
		'uuid': helper.get_uuid(),
		'static_red': 'ce2dcdb4507449c8a9cf659f6579105d',
		'content': [
			[
				"""
...
def page_not_found(error):
	...
	},
	{
		...
		'description': '',
		'uuid': helper.get_uuid(),
		'static_red': '54448e6ba03a41fdb656cbdd9c59aa63',
		'content': [
			[
				"""
...
def index():
	...
	},
	{
		...
		'description': '',
		'uuid': helper.get_uuid(),
		'static_red': '99f528967e424d87b6c09ce7174334b3',
		'content': [
			[
				"""
import session
