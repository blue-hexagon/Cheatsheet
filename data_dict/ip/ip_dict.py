			...
			'data': [
				{
					...
					'description': [
						Markup('Classless interdomain routing. Developed to provide more granularity than legacy classful addressing; CIDR notation is expressed as /##'),
					],
				...
				},
				{
					...
					'description': [
						Markup('Used on subnets to dynamically (and temporarily) allocate IP addresses. IPv6 uses DHCPv6'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Internet Control Message Protocol - aka. "ping". Is used for error reporting between routers. The IPv6 version is named accordingly: ICMPv6'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('A packet is a quantity of bytes send from a device to another. It has address and sender fields which is why it is a neat analogy'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('A term used when talking about IPv4\'s limited address space. It is countered by the enourmous address space introduced with IPv6'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Open Systems Interconnection. A conceptual model that characterises the communication protocols in telecommunication'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('The layer at which IP packets reside. It sits at layer 4 in the OSI model'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('0.0.0.0 – 127.255.255.255'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('128.0.0.0 - 191.255.255.255'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('192.0.0.0 - 223.255.255.255'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('224.0.0.0 - 239.255.255.255'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('240.0.0.0 - 255.255.255.255'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('127.0.0.0 - 127.255.255.255'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('10.0.0.0 - 10.255.255.255'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("RFC 1918"),
					'description': [
						Markup('172.16.0.0 - 172.31.255.255'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("RFC 1918"),
					'description': [
						Markup('192.168.0.0 - 192.168.255.255'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
		...
		'content': {
			...
			'data': [
				...
				},
				{
					...
					'description': [
						Markup('16,777,216'),
						Markup('This is equivalent to an IPv4 Internet or IPv4 /8'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('144,115,188,075,855,000'),
						Markup('1/128'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('288,230,376,151,711,000'),
						Markup('1/64'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('576,460,752,303,423,000'),
						Markup('1/32'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('1,152,921,504,606,840,000'),
						Markup('1/16'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('2,305,843,009,213,690,000'),
						Markup('1/8'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('4,611,686,018,427,380,000'),
						Markup('1/4'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('9,223,372,036,854,770,000'),
						Markup('1/2'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('18,446,744,073,709,500,000'),
						Markup('This is the standard end user allocation'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('36,893,488,147,419,100,000'),
						Markup('2'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('73,786,976,294,838,200,000'),
						Markup('4'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('147,573,952,589,676,000,000'),
						Markup('8'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('295,147,905,179,352,000,000'),
						Markup('16'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('590,295,810,358,705,000,000'),
						Markup('32'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('1,180,591,620,717,410,000,000'),
						Markup('64'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('2,361,183,241,434,820,000,000'),
						Markup('128'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('4,722,366,482,869,640,000,000'),
						Markup('256'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('9,444,732,965,739,290,000,000'),
						Markup('512'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('18,889,465,931,478,500,000,000'),
						Markup('1,024'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('37,778,931,862,957,100,000,000'),
						Markup('2,048'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('75,557,863,725,914,300,000,000'),
						Markup('4,096'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('151,115,727,451,828,000,000,000'),
						Markup('8,192'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('302,231,454,903,657,000,000,000'),
						Markup('16,384'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('604,462,909,807,314,000,000,000'),
						Markup('32,768'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('1,208,925,819,614,620,000,000,000'),
						Markup('65,536 This is the standard business allocation'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('2,417,851,639,229,250,000,000,000'),
						Markup('131,072'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('4,835,703,278,458,510,000,000,000'),
						Markup('262,144'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('9,671,406,556,917,030,000,000,000'),
						Markup('524,288'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('19,342,813,113,834,000,000,000,000'),
						Markup('1,048,576'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('38,685,626,227,668,100,000,000,000'),
						Markup('2,097,152'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('77,371,252,455,336,200,000,000,000'),
						Markup('4,194,304'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('154,742,504,910,672,000,000,000,000'),
						Markup('8,388,608'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('309,485,009,821,345,000,000,000,000'),
						Markup('16,777,216'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('618,970,019,642,690,000,000,000,000'),
						Markup('33,554,432'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('1,237,940,039,285,380,000,000,000,000'),
						Markup('67,108,864'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('2,475,880,078,570,760,000,000,000,000'),
						Markup('134,217,728'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('4,951,760,157,141,520,000,000,000,000'),
						Markup('268,435,456'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('9,903,520,314,283,040,000,000,000,000'),
						Markup('536,870,912'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('19,807,040,628,566,000,000,000,000,000'),
						Markup('1,073,741,824'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('39,614,081,257,132,100,000,000,000,000'),
						Markup('2,147,483,648'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('79,228,162,514,264,300,000,000,000,000'),
						Markup('4,294,967,296 This is the standard ISP Allocation'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/31"),
					'description': [
						Markup('158,456,325,028,528,000,000,000,000,000'),
						Markup('8,589,934,592'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/30"),
					'description': [
						Markup('316,912,650,057,057,000,000,000,000,000'),
						Markup('17,179,869,184'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/29"),
					'description': [
						Markup('633,825,300,114,114,000,000,000,000,000'),
						Markup('34,359,738,368'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/28"),
					'description': [
						Markup('1,267,650,600,228,220,000,000,000,000,000'),
						Markup('68,719,476,736'),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/27"),
					'description': [
						Markup('2,535,301,200,456,450,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/26"),
					'description': [
						Markup('5,070,602,400,912,910,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/25"),
					'description': [
						Markup('10,141,204,801,825,800,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/24"),
					'description': [
						Markup('20,282,409,603,651,600,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/23"),
					'description': [
						Markup('40,564,819,207,303,300,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/22"),
					'description': [
						Markup('81,129,638,414,606,600,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/21"),
					'description': [
						Markup('162,259,276,829,213,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/20"),
					'description': [
						Markup('324,518,553,658,426,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/19"),
					'description': [
						Markup('649,037,107,316,853,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/18"),
					'description': [
						Markup('1,298,074,214,633,700,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/17"),
					'description': [
						Markup('2,596,148,429,267,410,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/16"),
					'description': [
						Markup('5,192,296,858,534,820,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/15"),
					'description': [
						Markup('10,384,593,717,069,600,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/14"),
					'description': [
						Markup('20,769,187,434,139,300,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/13"),
					'description': [
						Markup('41,538,374,868,278,600,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/12"),
					'description': [
						Markup('83,076,749,736,557,200,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/11"),
					'description': [
						Markup('166,153,499,473,114,000,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/10"),
					'description': [
						Markup('332,306,998,946,228,000,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/9"),
					'description': [
						Markup('664,613,997,892,457,000,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("/8"),
					'description': [
						Markup('1,329,227,995,784,910,000,000,000,000,000,000,000'),
						Markup(''),
					],
					'example': helper.example_path(),
					'ext_link': '',
