			...
			'data': [
				{
					...
					'description': [
						Markup('Powerfull tool to network topology mapping and much more'),
					],
				...
				},
				{
					...
					'description': [
						Markup('A tool that automates OSINT collection'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('An advanced Twitter scraping & OSINT tool written in Python that doesn\'t use Twitter\'s API, allowing you to scrape a user\'s followers, following, Tweets and more while evading most API limitations'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('Incredibly fast crawler designed for OSINT'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('Search email addresses that has been subject to a data breach and get information about the data breach'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('Dorks for querying sensitive information or vulnerable content'),
					],
					'example': helper.example_path(),
			...
			'data': [
				{
					...
					'description': [
						Markup('Using search parameters to narrow down results in a Google search for information which is otherwise difficult to locate (see tools for a database of dorks)'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('Archive of webpages throughout time as they change'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('Another timecapsule for webpages'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('Both offer cached versions of webpages'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('Search for the exact phase'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Search for TermA or TermB'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Return results only from www.example.com'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Return results that are of filetype pdf'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Search for sites with the given words in their title'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Search for sites with the given words in their URL'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Search for sites with the given words in the text of the page'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Search for sites that have the given words in links pointing to them'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Show most recent cache of a webpage'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
