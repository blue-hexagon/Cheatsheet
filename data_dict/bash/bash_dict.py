...
cheatsheet = [
	...
	},
	{
		...
		'columns': 'col-lg-6 col-md-12',
		'uuid': helper.get_uuid(),
		'static_red': '2d6ba7df032a4f9084c551b1168d3b6a',
		'content': {
			'descriptor': {
				'Operator',
				'Effect'
			...
			'data': [
				{
					'static_red': Markup(helper.set_entry_folder('2a762c3b129a408ab50f866a1295650f')[0]),
					'flag': helper.set_entry_command_string('.'),
				...
				{
					'static_red': Markup(helper.set_entry_folder('92810c00e707463ca3c0c44e6db91e06')[0]),
					'flag': helper.set_entry_command_string('?'),
				...
				{
					'static_red': Markup(helper.set_entry_folder('1fc52bc53ac4439fafdb2db69ed212e7')[0]),
					'flag': helper.set_entry_command_string('*'),
				...
				{
					'static_red': Markup(helper.set_entry_folder('4c73e664c588408cb17a8c82c436c721')[0]),
					'flag': helper.set_entry_command_string('+'),
				...
				{
					'static_red': Markup(helper.set_entry_folder('63048395d08744a3b92704713a25a129')[0]),
					'flag': helper.set_entry_command_string('{N}'),
				...
				{
					'static_red': Markup(helper.set_entry_folder('1706c5b0d92a4ef28f30a3cf5a593d79')[0]),
					'flag': helper.set_entry_command_string('{N,}'),
				...
				{
					'static_red': Markup(helper.set_entry_folder('91346f20b9024a259b0605b7fdd76d5c')[0]),
					'flag': helper.set_entry_command_string('{N,M}'),
				...
				{
					'static_red': Markup(helper.set_entry_folder('57a866ef749b4d9d994096dce709a690')[0]),
					'flag': helper.set_entry_command_string('-'),
				...
				{
					'static_red': Markup(helper.set_entry_folder('e85d137087754d1790f6eff4d1d1d674')[0]),
					'flag': helper.set_entry_command_string('^'),
				...
				{
					'static_red': Markup(helper.set_entry_folder('05230512251e48da8ad0473ee328626b')[0]),
					'flag': helper.set_entry_command_string('$'),
				...
				{
					'static_red': Markup(helper.set_entry_folder('65594e054b5c48bc937a49eeef8e705d')[0]),
					'flag': helper.set_entry_command_string('[aoeiAOEI]'),
				...
				{
					'static_red': Markup(helper.set_entry_folder('c6f266118c7e46fea82f2a37b92b0b13')[0]),
					'flag': helper.set_entry_command_string('[^AOEIaoei]'),
				...
				{
					'static_red': Markup(helper.set_entry_folder('ef1a329f7bce42dfb509069199adb747')[0]),
					'flag': helper.set_entry_command_string('[a-f]'),
