...
information = {
	...
	'description': 'Vim is a contaction of Vi IMproved and is a clone of the text-editor Vi but with additions (improvements). It is a highly configurable text-editor with an initial released version seeing the world in 1991. It is mainly designed as a command-line application but also comes in a GUI version.',
		...
		'content': {
			...
			'data': [
				...
				},
				{
					...
					'description': [
						Markup('Open man page for word under the cursor'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
		...
		'content': {
			...
			'data': [
				...
				},
				{
					...
					'description': [
						Markup('Move to middle of screen'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('L'),
					'description': [
						Markup('Move to bottom of screen'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Jump forwards to the start of a word'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('W'),
					'description': [
						Markup('Jump forwards to the start of a word (words can contain punctuation)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Jump forwards to the end of a word'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('E'),
					'description': [
						Markup('Jump forwards to the end of a word (words can contain punctuation)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Jump backwards to the start of a word'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('B'),
					'description': [
						Markup('Jump backwards to the start of a word (words can contain punctuation)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move to matching character (default supported pairs: \'()\', \'{}\', \'[]\' - use :h matchpairs in vim for more info)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Jump to the start of the line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('^'),
					'description': [
						Markup('Jump to the first non-blank character of the line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('$'),
					'description': [
						Markup('Jump to the end of the line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Jump to the last non-blank character of the line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Go to the first line of the document'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Go to the last line of the document'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Jump to next occurrence of character x'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Jump to before next occurrence of character x'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('Fx'),
					'description': [
						Markup('Jump to previous occurence of character x'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('Tx'),
					'description': [
						Markup('Jump to after previous occurence of character x'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string(';'),
					'description': [
						Markup('Repeat previous f, t, F or T movement'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string(','),
					'description': [
						Markup('Repeat previous f, t, F or T movement, backwards'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('}'),
					'description': [
						Markup('Jump to next paragraph (or function/block, when editing code)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('{'),
					'description': [
						Markup('Jump to previous paragraph (or function/block, when editing code)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Center cursor on screen'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move screen down one line (without moving cursor)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move screen up one line (without moving cursor)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move back one full screen'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move forward one full screen'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move forward 1/2 a screen'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
			...
			'data': [
				{
					...
					'description': [
						Markup('Insert before the cursor'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('I'),
					'description': [
						Markup('Insert at the beginning of the line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Insert (append) after the cursor'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('A'),
					'description': [
						Markup('Insert (append) at the end of the line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Append (open) a new line below the current line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('O'),
					'description': [
						Markup('Append (open) a new line above the current line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Insert (append) at the end of the word'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Delete the character before the cursor during insert mode'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Delete word before the cursor during insert mode'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Begin new line during insert mode'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Indent (move right) line one shiftwidth during insert mode'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('Ctrl + d'),
					'description': [
						Markup('De-indent (move left) line one shiftwidth during insert mode'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Insert (auto-complete) next match before the cursor during insert mode'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Insert (auto-complete) previous match before the cursor during insert mode'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Insert the contents of register x'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
			...
			'data': [
				{
					...
					'description': [
						Markup('Replace a single character'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('J'),
					'description': [
						Markup('JJoin line below to the current one with one space in between'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Join line below to the current one without space in between'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('g~'),
					'description': [
						Markup('Switch case up to motion'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Change to lowercase up to motion'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('gU'),
					'description': [
						Markup('Change to uppercase up to motion'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Change (replace) entire line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Change (replace) to the end of the line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Change (replace) entire word'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Change (replace) to the end of the word'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Delete character and substitute text'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('S'),
					'description': [
						Markup('Delete line and substitute text (same as cc)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Transpose two letters (delete and paste)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('U'),
					'description': [
						Markup('Restore (undo) last changed line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
			...
			'data': [
				{
					...
					'description': [
						Markup('Start visual mode, mark lines, then do a command (like y-yank)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('V'),
					'description': [
						Markup('Start linewise visual mode'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('o'),
					'description': [
						Markup('Move to other end of marked area'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Start visual block mode'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('O'),
					'description': [
						Markup('Move to other corner of block'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
		...
		'content': {
			...
			'data': [
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('u'),
					'description': [
						Markup('Change marked text to lowercase'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('U'),
					'description': [
						Markup('Change marked text to uppercase'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
		...
		'content': {
			...
			'data': [
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('"xp'),
					'description': [
						Markup('Paste contents of register x'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('"+y'),
					'description': [
						Markup('Yank into the system clipboard register'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Paste from the system clipboard register'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
		...
		'content': {
			...
			'data': [
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('"'),
					'description': [
						Markup('Unnamed register, last delete or yank'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('*'),
					'description': [
						Markup('Clipboard contents (X11 primary)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('+'),
					'description': [
						Markup('Clipboard contents (X11 clipboard)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('-'),
					'description': [
						Markup('Last small (less than a line) delete'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
		...
		'content': {
			...
			'data': [
				...
				},
				{
					...
					'description': [
						Markup('Set current position for mark A'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('`a'),
					'description': [
						Markup('Jump to position of mark A'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Yank text to position of mark A'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('`0'),
					'description': [
						Markup('Go to the position where Vim was previously exited'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('`"'),
					'description': [
						Markup('Go to the position when last editing this file'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('`.'),
					'description': [
						Markup('Go to the position of the last change in this file'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('``'),
					'description': [
						Markup('Go to the position before the last jump'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Go to newer position in jump list'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Go to older position in jump list'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('g,'),
					'description': [
						Markup('Go to newer position in change list'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('g;'),
					'description': [
						Markup('Go to older position in change list'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Jump to the tag under cursor'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
		...
		'content': {
			...
			'data': [
				...
				},
				{
					...
					'description': [
						Markup('Yank (copy) the characters of the word from the cursor position to the start of the next word'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('y$'),
					'description': [
						Markup('Yank (copy) to end of line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('p'),
					'description': [
						Markup('Put (paste) the clipboard after cursor'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('P'),
					'description': [
						Markup('Put (paste) before cursor'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Delete (cut) the characters of the word from the cursor position to the start of the next word'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('D'),
					'description': [
						Markup('Delete (cut) to the end of the line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
			...
			'data': [
				{
					...
					'flag': helper.set_entry_command_string('>>'),
					'description': [
						Markup('Indent (move right) line one shiftwidth'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('<<'),
					'description': [
						Markup('De-indent (move left) line one shiftwidth'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('>%'),
					'description': [
						Markup('Indent a block with () or {} (cursor on brace)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('>ib'),
					'description': [
						Markup('Indent inner block with ()'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('>at'),
					'description': [
						Markup('Indent a block with <> tags'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('=%'),
					'description': [
						Markup('Re-indent a block with () or {} (cursor on brace)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('=iB'),
					'description': [
						Markup('Re-indent inner block with {}'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Re-indent entire buffer'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string(']p'),
					'description': [
						Markup('Paste and adjust indent to current line'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
			...
			'data': [
				{
					...
					'flag': helper.set_entry_command_string(':w'),
					'description': [
						Markup('Write (save) the file, but don\'t exit'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Write out the current file using sudo'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string(':q'),
					'description': [
						Markup('Quit (fails if there are unsaved changes)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Quit and throw away unsaved changes'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Write (save) and quit on all tabs'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
		...
		'content': {
			...
			'data': [
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('?pattern'),
					'description': [
						Markup('Search backward for pattern'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('\'Very magic\' pattern: non-alphanumeric characters are interpreted as special regex symbols (no escaping needed)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Repeat search in same direction'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('N'),
					'description': [
						Markup('Repeat search in opposite direction'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Replace all old with new throughout file'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Replace all old with new throughout file with confirmations'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Remove highlighting of search matches'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
			...
			'data': [
				{
					...
					'description': [
						Markup('Search for pattern in multiple files'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Jump to the previous match'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Open a window containing the list of matches'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Close the quickfix window'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
			...
			'data': [
				{
					...
					'description': [
						Markup('Open a file in a new tab'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move the current split window into its own tab'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move to the previous tab'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move current tab to the #th position (indexed from 0)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Close the current tab and all its windows'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Close all tabs except for the current one'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Command - run the command on all tabs (e.g. :tabdo q - closes all opened tabs)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
			...
			'data': [
				{
					...
					'description': [
						Markup('Edit a file in a new buffer'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Go to the previous buffer'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Delete a buffer (close a file)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Go to a buffer by index #'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Open a file in a new buffer and split window'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Open a file in a new buffer and vertically split window'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Edit all buffers as vertical windows'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Edit all buffers as tabs'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Split window vertically'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Exchange current window with next one'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('Ctrl + w='),
					'description': [
						Markup('Make all windows equal height & width'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move cursor to the left window (vertical split)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move cursor to the right window (vertical split)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move cursor to the window below (horizontal split)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Move cursor to the window above (horizontal split)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
			...
			'data': [
				{
					...
					'description': [
						Markup('Manually define a fold up to motion'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Delete fold under the cursor'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Toggle fold under the cursor'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Open fold under the cursor'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Close fold under the cursor'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Reduce (open) all folds by one level'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Fold more (close) all folds by one level'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Toggle folding functionality'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string(']c'),
					'description': [
						Markup('Jump to start of next change'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'flag': helper.set_entry_command_string('[c'),
					'description': [
						Markup('Jump to start of previous change'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Obtain (get) difference (from other buffer)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Put difference (to other buffer)'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Make current window part of diff'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
				...
				},
				{
					...
					'description': [
						Markup('Switch off diff mode for current window'),
					],
					'video': Markup(''),
					'example': helper.example_path(),
					'ext_link': '',
