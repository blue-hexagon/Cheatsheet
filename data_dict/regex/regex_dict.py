			...
			'data': [
				{
					...
					'description': [
						Markup('Start of string, or start of line in multi-line pattern'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("$"),
					'description': [
						Markup('End of string, or end of line in multi-line pattern'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
		...
		'content': {
			...
			'data': [
				...
				},
				{
					...
					'description': [
						Markup('Printed characters and spaces'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
				},
				{
					...
					'description': [
						Markup('Digits, letters and underscore'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
		...
		'content': {
			...
			'data': [
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("?>"),
					'description': [
						Markup('Once-only Subexpression'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
			...
			'data': [
				{
					...
					'flag': helper.set_entry_command_string("\\"),
					'description': [
						Markup('Escape following character'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
			...
			'data': [
				{
					...
					'flag': helper.set_entry_command_string("."),
					'description': [
						Markup('Any character except new line (\n)'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("(?:...)"),
					'description': [
						Markup('Passive (non-capturing) group'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
				...
				},
				{
					...
					'description': [
						Markup('Lower case letter from a to q'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
				},
				{
					...
					'flag': helper.set_entry_command_string("[A-Q]"),
					'description': [
						Markup('Upper case letter from A to Q'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("\\x"),
					'description': [
						Markup('Group/subpattern number "x"'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
		...
		'content': {
			...
			'data': [
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("s"),
					'description': [
						Markup('Treat string as single line'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
				},
				{
					...
					'flag': helper.set_entry_command_string("x"),
					'description': [
						Markup('Allow comments and whitespace in pattern'),
					],
					'example': helper.example_path(),
					'video': Markup(''),
					'uuid': helper.get_uuid(),
