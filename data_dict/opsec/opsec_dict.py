			...
			'data': [
				{
					...
					'description': [
						Markup('A general term for fradulent attempts to obtain sensitive information or data such as usernames, passwords, account details and so on. The term phishing has roots in the word phreaking'),
					],
				...
				},
				{
					...
					'description': [
						Markup('Online deception that involces getting to know someone closely in order to extract sensitive information or data from them'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Malicious emails that targets an individual or a multitude of people. Often contains a link to a malicious webpage or a piece of malware such as ransomware'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Highly targeted phishing'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('A relatively new attack vector. Essentially the same as smishing but constrained to Social Media platforms'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('In line with vishing. Textual phishing. Can be either SMS or any other textual communication type such as Telegram, Messenger etc'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Term used to describe phishing against high-profile (business) targets'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('A woman (most often) initiating sexual contact over a webcam or similar while screencapturing the sexual acts and using the material to extort the target'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('A type of malware gaining traction in recent years. Works by holding your data ransom until you pay for a de-cryption key. Sometimes you get to have your data back, other times you do not'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('A password manager helps you manage logins and enables the use of complex random passwords for all your logins as you do not have to rely on memory'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Reusing the same password makes cracking possible if you happend to ever fall victim to a databreach'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Sensitive information such as password hashes being leaked because of a security hole'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Attempting to crack a password hash from a target whose data was leaked in a databreach'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('A phone "phreaker". A type of social engineerer that gains entrance into telecommunication networks by use of social engineering tactics. Kevin Mitnick (formerly FBIs most wanted hacker) is well known for phreaking'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('2-Factor Authentication. People have lost their life savings because of weak 2FA such as SMSs which can be either intercepted or in the case of social engineering redirected to a new cellphone own by the social engineer'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('One time passwords through SMS; susceptible to SIM-swapping fraud.'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('One time codes through apps like Google Authenticator for example.'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Hardware authentication device like a YubiKey for example.'),
					],
					'example': helper.example_path(),
			...
			'data': [
				{
					...
					'description': [
						Markup('Biometric IDs can sometimes be bypassed by a printed image. Your camera can be exploited. GPS location can be obtained by webpages.'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Internet of things-devices are known for their weak, hardcoded or guessable passwords, insecure default settings, lack of secure update mechanisms and a lot more.'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Computers are exceptionally prone to malware if used by people that have no clue about common security practices'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Bring Your Own Device (BYOD) comes with a lot risks. Data-theft, lost devices and malware infiltration are perhaps the most significant.'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('The (I)nvisible (I)nternet (P)roject. A fully encrypted private network layer.'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('A peer-to-peer platform for censorship-resistant communication and publishing'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('The Onion Router. Perhaps the most well known darknet'),
					],
					'example': helper.example_path(),
			...
			'data': [
				{
					...
					'description': [
						Markup('If an SSH fingerprint changes it either means the machine you are connecting to has changed their public key or that you are connecting to a different machine than what you think.'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Can be used to anonymize your computer through a VPS container whereby you can run a "clean slate"-browser session'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('Be aware if your provider saves logfiles or not (they might have their hand forced at some point if they do), or just assume all communication is secretly tapped.'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('Tool for encrypting portable media devices. You should use full-disk encryption on your PC. Veracrypt also has a neat feature for creating hidden encrypted volumes'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'flag': helper.set_entry_command_string("Password Manager"),
					'description': [
						Markup('A tool for storing unique user-password combinations so that you do not have to rely on memory'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('A technique for encrypting a harddrive. For windows use Bitlocker. For Linux there are LUKS and Dm-cryot. It can be done on Android as well'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('Formed in the 1940s between UK-USA. New Zealand, Canada and Australia later joined'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('An expansion of the 5-eyes alliance. Cooperation is less intense. The Netherlands, France, Denmark and Norway are part of this alliance as well as the rest of the 5-eye countries'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('An expansion of the 9-eyes alliance. Cooperation is less intense than the 9-eyes alliance. Countries added are Belgium, Italy, Germany, Spain and Sweden'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('An IRC hostmask cloak replaces your IP address or hostname with a cloak.'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('An encrypted thumbdrive bootable OS with security features that runs TOR by default.'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('Security focused operating system that relies on compartmentalization (security by isolation); effectively spinning up isolated instances of VMs for each application.'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('Another security-focused Linux distribution with some neat features like keystroke anonymization, kernel modules for overwriting TCP ISNs, hardening the OS and more.'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('OS hardening is a process of reducing the attack surface by various means such as closing down ports, containerization/virtualization of applications, IPS/IDS, relevant kernel modules and much more.'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('Multiple services exists to create one-time email addresses. Beware these are not usable by other people aswell. You can setup forwarding to an intermediate email address which then forwards to your regular email address'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('Creation of email messages with forged headers that results in a forged sender address'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
			...
			'data': [
				{
					...
					'description': [
						Markup('All transactions on Bitcoin for example are stored on public ledgers and can thus be traced easily. Some cryptocurrencies have made attempts to curcumvent this feature (e.g. Monero)'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('A vulnerability that allows hackers to read texts, listen to calls and track their locations. This vulerability have been used against populations and army-staff aswell as political targets'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('A bitcoin wallet that is online and connected'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('An offline wallet that is stored on a hardware device'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('A nasty set of techniques to identify, track and collect information on users without their consent.'),
					],
					'example': helper.example_path(),
				...
				},
				{
					...
					'description': [
						Markup('A small piece of data stored on an end-users computer by a web browser. Used to remember stateful information and exploited by advertising companies to track and identify users.'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
				...
				},
				{
					...
					'description': [
						Markup('A cookie that is automatically recreated after being deleted. Accomplished by storing the cookies content in multiple locations client-side as well as server-side.'),
					],
					'example': helper.example_path(),
					'ext_link': '',
					'video': Markup(''),
	...
	ResourceCollector.recieve_resources_from_dicts(
		{
			...
			'affiliate_link': Markup(
				'<a target="_blank" rel="nofollow noopener" href="https://www.amazon.com/gp/offer-listing/B0898YGR58/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B0898YGR58&linkCode=am2&tag=cheatsheet01-20&linkId=989552293f9b45b0a395d80f4fad192e"><img width="122" height="150" alt="Amazon affiliate product" '
				'border="0" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&MarketPlace=US&ASIN=B0898YGR58&ServiceVersion=20070822&ID=AsinImage&WS=1&Format=_SL160_&tag=cheatsheet01-20" ></a>'),
		...
		},
		{
			...
			'affiliate_link': Markup(
				'<a target="_blank" rel="nofollow noopener" href="https://www.amazon.com/gp/offer-listing/B0897MWMQD/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B0897MWMQD&linkCode=am2&tag=cheatsheet01-20&linkId=6d7a5c76cf706df0a4a568c8797286df"><img width="150" height="150" alt="Amazon affiliate product" '
				'border="0" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&MarketPlace=US&ASIN=B0897MWMQD&ServiceVersion=20070822&ID=AsinImage&WS=1&Format=_SL160_&tag=cheatsheet01-20" ></a>'),
			'footer': Markup(''),
			'description': '',
		},
		{
			...
			'affiliate_link': Markup(
				'<a target="_blank" rel="nofollow noopener" href="https://www.amazon.com/gp/offer-listing/B08K2Q9RCK/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B08K2Q9RCK&linkCode=am2&tag=cheatsheet01-20&linkId=46c79549564deb7155dadb9ed6983434"><img width="150" height="150" alt="Amazon affiliate product" '
				'border="0" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&MarketPlace=US&ASIN=B08K2Q9RCK&ServiceVersion=20070822&ID=AsinImage&WS=1&Format=_SL160_&tag=cheatsheet01-20" ></a>'),
			'footer': Markup(''),
			'description': '',
		},
		{
			...
			'affiliate_link': Markup(
				'<a target="_blank" rel="nofollow noopener" href="https://www.amazon.com/gp/offer-listing/B07WGJ1DNJ/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B07WGJ1DNJ&linkCode=am2&tag=cheatsheet01-20&linkId=4ed9855501e217fb7b63f640a2e03836"><img width="150" height="150" alt="Amazon affiliate product" '
				'border="0" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&MarketPlace=US&ASIN=B07WGJ1DNJ&ServiceVersion=20070822&ID=AsinImage&WS=1&Format=_SL160_&tag=cheatsheet01-20" ></a>'),
			'footer': Markup(''),
			'description': '',
		},
		{
			...
			'affiliate_link': Markup(
				'<a target="_blank" rel="nofollow noopener" href="https://www.amazon.com/gp/offer-listing/0316380520/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=0316380520&linkCode=am2&tag=cheatsheet01-20&linkId=7f479f5d06f4fa93dce38b0dbf3f15b7"><img width="100" height="150" alt="Amazon affiliate product" '
				'border="0" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&MarketPlace=US&ASIN=0316380520&ServiceVersion=20070822&ID=AsinImage&WS=1&Format=_SL160_&tag=cheatsheet01-20" ></a>'),
			'footer': Markup('Written by Kevin Mitnick'),
			'description': 'Details his years as FBIs most wanted hacker.',
		},
		{
			'title': Markup('Ghost in The Wires'),
			'affiliate_link': Markup(
				'<a target="_blank" rel="nofollow noopener" href="https://www.amazon.com/gp/offer-listing/0316037729/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=0316037729&linkCode=am2&tag=cheatsheet01-20&linkId=0edb2bdb3ccf29769b876bed0ce747ba"><img width="99" height="150" alt="Amazon affiliate product" '
				'border="0" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&MarketPlace=US&ASIN=0316037729&ServiceVersion=20070822&ID=AsinImage&WS=1&Format=_SL160_&tag=cheatsheet01-20" ></a>'),
			'footer': Markup('By Kevin Mitnick'),
			'description': 'Mitnicks year as a phreaker',
		},
		{
			'title': Markup('Phishing Dark Waters'),
			'affiliate_link': Markup(
				'<a target="_blank" rel="nofollow noopener" href="https://www.amazon.com/gp/offer-listing/1118958470/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=1118958470&linkCode=am2&tag=cheatsheet01-20&linkId=ae1b07dbf36c95383a163cb34733fd7f"><img width="100" height="150" alt="Amazon affiliate product" '
				'border="0" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&MarketPlace=US&ASIN=1118958470&ServiceVersion=20070822&ID=AsinImage&WS=1&Format=_SL160_&tag=cheatsheet01-20" ></a>'),
		...
		},
		{
			...
			'affiliate_link': Markup(
				'<a target="_blank" rel="nofollow noopener" href="https://www.amazon.com/gp/offer-listing/B07H4WGLPN/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B07H4WGLPN&linkCode=am2&tag=cheatsheet01-20&linkId=78aec361744782adaff2ec41f98894c0"><img width="163" height="150" alt="Amazon affiliate product" '
				'border="0" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&MarketPlace=US&ASIN=B07H4WGLPN&ServiceVersion=20070822&ID=AsinImage&WS=1&Format=_SL160_&tag=cheatsheet01-20" ></a>'),
			'footer': Markup('Useful for important meetings'),
			'description': '',
		},
		{
			'title': Markup('Yubikey 5 NFC'),
			'affiliate_link': Markup(
				'<a target="_blank" rel="nofollow noopener" href="https://www.amazon.com/gp/offer-listing/B07HBD71HL/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B07HBD71HL&linkCode=am2&tag=cheatsheet01-20&linkId=be0664a2781161b03151338c3e317576"><img width="150" height="150" alt="Amazon affiliate product" '
				'border="0" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&MarketPlace=US&ASIN=B07HBD71HL&ServiceVersion=20070822&ID=AsinImage&WS=1&Format=_SL160_&tag=cheatsheet01-20" ></a>'),
			'footer': Markup(''),
			'description': '',
		},
